...
function likeReview() {
    $.post(
        base_url + 'danhGiaMonAn/likeReview', // URL 
        {
            MaDGMA : $('#maDGMA').val()
        },  // Data
...
function likeComment(btnThich) {
    $.post(
        base_url + 'danhGiaMonAn/likeComment', // URL 
        {
            MaBLMA : btnThich.val()
        },  // Data
        function (result) { // Success
...
{
    $.post(
        base_url + 'danhGiaMonAn/insertBinhLuan', // URL 
        {
            NoiDungBLMA : $('#comment').val(),
            MaDGMA : $('#maDGMA').val()
        },  // Data
        function(result){ // Success
            $('.no-comment').remove();
...
function deleteComment(btnXoa) {
    $.post(
        base_url + 'danhGiaMonAn/deleteComment', // URL 
        {
            MaBLMA : btnXoa.val(),
        },  // Data
        function(result){ // Success
