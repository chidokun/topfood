<div class="panel panel-default">
  <p class="panel-heading t-panel-header t-border-panel" style="border-bottom:4px solid orange">Top review ưa thích nhất</p>
      ...
      <div style="height:103px; border-bottom:1px solid #dddddd">
        <a href="<?php echo base_url('dangKy'); ?>" >
            <div class="col-md-2" style="padding:25px 14px;">
                <span style="color:<?php echo $color["$stt"] ; ?>" class="t-STT-top"><?php $stt++; echo $stt; ?>
                </span>
            </div>
